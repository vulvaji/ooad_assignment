...
public class SpiralMemory_Testing {
	
	private SpiralMemory spiralObj;
	@Rule public TestName name = new TestName();
	
	@Before
	public void setUp(){		
		spiralObj  = new SpiralMemory();
	}

	@Test
	public void testMemoryGenerator() {
		assertNotNull(spiralObj);
	}
	...
	public void testTestValueGivenInExample_1(){
		...
		assertEquals(expected_shorteststeps, spiralObj.spiral_memory_generator(TestValueGivenInExample));
	...
	public void testMaxValue_2000(){
		...
		System.out.println("Started executing "+name.getMethodName()+"     *************" );
		assertEquals(expected_shorteststeps, spiralObj.spiral_memory_generator(TestMaxValue));
		System.out.println("Execution completed for "+name.getMethodName()+"     *************" + "\r\n");		
	}
	...
	public void testNegative(){
		...
		System.out.println("Started executing "+name.getMethodName()+"     *************" );
		spiralObj.spiral_memory_generator(TestNegativeValue);
		System.out.println("Execution completed for "+name.getMethodName()+"     *************" + "\r\n");		
	}
	...
	public void testIntAsAString(){
		...
		System.out.println("Started executing "+name.getMethodName()+"     *************" );
		assertEquals(expected_shorteststeps, spiralObj.spiral_memory_generator(TestIntAsAString));
		System.out.println("Execution completed for "+name.getMethodName()+"     *************" + "\r\n");		
	}
	...
	public void testFindsteps_forUserdefinedValidValue(){
		...
		int user_input = spiralObj.getInputFromUser();	
	
		assertNotNull(spiralObj.spiral_memory_generator(user_input));
		System.out.println("*************     Execution completed for "+name.getMethodName()+"     *************" + "\r\n");
	}
